...
with st.container():
    ...
    with col1:
        ...
        num_samples = st.number_input("Número de muestras", min_value=100, max_value=1000, value=300)
        num_classes = st.number_input("Número de clases", min_value=2, max_value=5, value=3)
